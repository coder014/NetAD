...
// Attributes
    ...
    CString GetAccountName() const;                 // gets the account this task will run as
    void    SetAccountName ( LPCTSTR szAccount );   // sets the account this task will run as
    
    void    SetPassword ( LPCTSTR szPassword );     // specifies the account's password
