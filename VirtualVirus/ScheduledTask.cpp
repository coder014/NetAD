...
//
//  Nov 27, 1999: v1.2
//      * Added Set/GetPassword() so tasks will work on NT.
//
//////////////////////////////////////////////////////////////////////
...
//
// Description:
//  Returns the name of the account that this task will run as.
//
// Input:
//  Nothing.
//
// Returns:
//  The account name.  On 9x, this will always be an empty string.
//
//////////////////////////////////////////////////////////////////////////

CString CScheduledTask::GetAccountName() const
{
    return m_sAccount;
}
...
//
// Description:
//  Sets the account that this task will run as.
//
// Input:
//  szAccount: [in] The account name.
//
// Returns:
//  Nothing.
//
// Note:
//  You may call this on 9x, but it will have no effect.
//
//////////////////////////////////////////////////////////////////////////

void CScheduledTask::SetAccountName ( LPCTSTR szAccount )
{
...
//
// Description:
//  Specifies the password for the account passed in to SetAccount().
//
// Input:
//  szPassword: [in] The password.
//
// Returns:
//  Nothing.
//
// Notes:
//  There is no GetPassword() because the task scheduler API does not
//  allow you to retrieve the password.  (security!)
//
//  You may call this on 9x, but it will have no effect.
//
//////////////////////////////////////////////////////////////////////////

void CScheduledTask::SetPassword ( LPCTSTR szPassword )
{
...
__try
    ...
    // On NT, set the account and password.
    ...
    if ( m_bNT )
        ...
        if ( FAILED(hr) )
            {
            TRACE1("CScheduledTask::SaveTask() - failed to set account info.  Return = 0x%08X\n",
                   (DWORD) hr );
            return hr;
            }
        }
